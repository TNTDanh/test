...
Hệ sinh thái đặt đồ ăn đa kênh (MERN + Expo). Người dùng duyệt menu, thêm giỏ, thanh toán (Stripe/COD), theo dõi đơn; đội vận hành có portal quản lý món/đơn, và console quản trị người dùng.
...
- Duyệt danh mục, thêm/giảm giỏ, thanh toán Stripe hoặc COD, theo dõi trạng thái đơn.
